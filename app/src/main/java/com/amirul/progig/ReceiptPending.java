...
public class ReceiptPending extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_receipt_pending);
        ...
        DocumentReference docRef = db.collection("progig").document("ProGig "+gigID);
        docRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(ReceiptPending.this, "Failed to Connect", Toast.LENGTH_SHORT).show();
                }
            }
        });
                ...
                documentReference
                        ...
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Intent intent=new Intent(ReceiptPending.this,Dashboard.class);
